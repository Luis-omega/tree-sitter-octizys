...
enum ts_symbol_identifiers {
  ...
  anon_sym_as = 38,
  sym_source_file = 39,
  sym_local_variable = 40,
  sym__logic_path_item = 41,
  sym__logic_path_item_list = 42,
  sym_logic_path = 43,
  sym_type_literal = 44,
  ...
  sym_expression_literal = 50,
  sym_expression_variable = 51,
  sym_expression_parens = 52,
  sym__expression_atom = 53,
  sym_expression_application = 54,
  sym_inner_parameter_alone = 55,
  sym_inner_parameter_with_type = 56,
  sym_inner_parameter = 57,
  sym_parameter = 58,
  sym_parameters = 59,
  sym_scheme_start = 60,
  sym_definition_type_annotation = 61,
  sym_definition = 62,
  sym_expression_function = 63,
  sym_expression_if = 64,
  sym_expression_let = 65,
  sym__expression = 66,
  sym_import_logic_path = 67,
  sym_import_statement = 68,
  sym_top_item = 69,
  aux_sym_source_file_repeat1 = 70,
  aux_sym_type_arrow_repeat1 = 71,
  aux_sym_expression_application_repeat1 = 72,
  aux_sym_parameters_repeat1 = 73,
  aux_sym_scheme_start_repeat1 = 74,
  aux_sym_expression_let_repeat1 = 75,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym__logic_path_item] = "_logic_path_item",
  [sym__logic_path_item_list] = "_logic_path_item_list",
  [sym_logic_path] = "logic_path",
  ...
  [sym_import_logic_path] = "import_logic_path",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym__logic_path_item] = sym__logic_path_item,
  [sym__logic_path_item_list] = sym__logic_path_item_list,
  [sym_logic_path] = sym_logic_path,
  ...
  [sym_import_logic_path] = sym_import_logic_path,
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [sym__logic_path_item] = {
    .visible = false,
    .named = true,
  },
  [sym__logic_path_item_list] = {
    .visible = false,
    .named = true,
  },
  [sym_logic_path] = {
...
enum ts_field_identifiers {
  field_alias = 1,
  field_arguments = 2,
  field_definition_type_annotation = 3,
  field_function = 4,
  field_name = 5,
  field_origin = 6,
  field_output_type = 7,
  field_parameters = 8,
  field_scheme_start = 9,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym__identifier_character_set_1, 684, lookahead)) ADVANCE(126);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(92);
    ...
    case 126:
      ...
      if (set_contains(sym__identifier_character_set_2, 800, lookahead)) ADVANCE(126);
      END_STATE();
    case 127:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_logic_path, 2, 0, 0),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_logic_path, 2, 0, 0),
  [37] = {.entry = {.count = 1, .reusable = false}}, SHIFT(86),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_local_variable, 1, 0, 0),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_local_variable, 1, 0, 0),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_application, 1, 0, 3),
  [45] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_application, 1, 0, 3),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_application, 2, 0, 7),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_application, 2, 0, 7),
  [51] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0),
  [62] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__logic_path_item, 2, 0, 0),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__logic_path_item, 2, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__logic_path_item_list, 2, 0, 0),
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__logic_path_item_list, 2, 0, 0),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_variable, 1, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_variable, 1, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_parens, 3, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_parens, 3, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_parens, 5, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_parens, 5, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_literal, 1, 0, 0),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_literal, 1, 0, 0),
  ...
  [95] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(40),
  [98] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(67),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_type_arrow_repeat1, 2, 0, 0),
  [103] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_type_arrow_repeat1, 2, 0, 0), SHIFT_REPEAT(25),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_arrow, 2, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_arrow, 1, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_parens, 3, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_literal, 1, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_variable, 1, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 2, 0, 0),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_logic_path, 1, 0, 0),
  [126] = {.entry = {.count = 1, .reusable = false}}, SHIFT(9),
  [128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inner_parameter_alone, 1, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 1, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0),
  [138] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(45),
  [141] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_let_repeat1, 2, 0, 0), SHIFT_REPEAT(40),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_expression_let_repeat1, 2, 0, 0),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_let, 4, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_function, 4, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_function, 5, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_if, 6, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scheme_start, 3, 0, 9),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scheme_start, 3, 0, 9),
  [160] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_scheme_start_repeat1, 2, 0, 0), SHIFT_REPEAT(40),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_scheme_start_repeat1, 2, 0, 0),
  [165] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [169] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_top_item, 2, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_top_item, 2, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inner_parameter_with_type, 3, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 2, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inner_parameter, 1, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 2, 0, 1),
  ...
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 4, 0, 5),
  [193] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [195] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 3, 0, 4),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition_type_annotation, 2, 0, 2),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 4, 0, 8),
  [205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition_type_annotation, 5, 0, 11),
  [209] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [211] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition_type_annotation, 4, 0, 10),
  [215] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [217] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition_type_annotation, 3, 0, 6),
