...
enum ts_symbol_identifiers {
  ...
  sym_type_parens = 38,
  sym__type_atom_no_var = 39,
  sym__type_atom = 40,
  sym_type_arrow = 41,
  sym__type_expression = 42,
  sym_expression_literal = 43,
  sym_expression_variable = 44,
  sym_expression_parens = 45,
  sym__expression_atom = 46,
  sym_expression_application = 47,
  sym_parameter_alone = 48,
  sym_parameter_with_type = 49,
  sym_definition_parameter = 50,
  sym_function_parameter = 51,
  sym_definition_parameters = 52,
  sym_definition = 53,
  sym_expression_function = 54,
  sym_expression_if = 55,
  sym_expression_let = 56,
  sym__expression = 57,
  sym_top_item = 58,
  aux_sym_source_file_repeat1 = 59,
  aux_sym_type_arrow_repeat1 = 60,
  aux_sym_expression_application_repeat1 = 61,
  aux_sym_expression_function_repeat1 = 62,
  aux_sym_expression_let_repeat1 = 63,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_application, 1, 0, 1),
  [27] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_application, 1, 0, 1),
  [29] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [32] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0), SHIFT_REPEAT(25),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0),
  [40] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0), SHIFT_REPEAT(25),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_expression_application_repeat1, 2, 0, 0),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_application, 2, 0, 3),
  [47] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_application, 2, 0, 3),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_local_variable, 1, 0, 0),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_local_variable, 1, 0, 0),
  [53] = {.entry = {.count = 1, .reusable = false}}, SHIFT(41),
  [55] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_parens, 5, 0, 0),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_parens, 5, 0, 0),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_variable, 1, 0, 0),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_variable, 1, 0, 0),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_parens, 3, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_parens, 3, 0, 0),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_literal, 1, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_literal, 1, 0, 0),
  [73] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_function_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_function_repeat1, 2, 0, 0),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_function_repeat1, 2, 0, 0), SHIFT_REPEAT(47),
  ...
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_type_arrow_repeat1, 2, 0, 0),
  [94] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_type_arrow_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_arrow, 2, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_arrow, 1, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = false}}, SHIFT(10),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_if, 6, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_let, 4, 0, 0),
  [109] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_let_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_expression_let_repeat1, 2, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_function, 4, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_parens, 3, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_variable, 1, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_literal, 1, 0, 0),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_with_type, 3, 0, 0),
  [124] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_alone, 1, 0, 0),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameter, 3, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameter, 1, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition_parameters, 3, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [136] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition_parameter, 1, 0, 0),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_top_item, 2, 0, 0),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition_parameters, 1, 0, 0),
  ...
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 3, 0, 2),
  ...
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 7, 0, 5),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 5, 0, 4),
